        ...
        >
            ...
            >
                <span
                    ...
                    @mousedown="drag"
                >
                    채팅방 - <span class="count">({{ userCount }}명 참여)</span>
                </span>
                <button 
                ...
                >
                    ...
                    <template v-else>
                        <div class="event-message message">
                            <div><strong>{{ item.content }}</strong>{{ item.event }}</div>
                        </div>
                    </template>
                </li>
            </ul>
    ...
    methods: {
        ...
        onMessageReceived(payload) {
            ...
            case 'JOIN':
                ...
                content.event = '님이 참가했습니다';
                break;
            case 'LEAVE':
                content.content = content.sender;
                content.event = '님이 퇴장했습니다';
                break;
            case 'CHAT':
